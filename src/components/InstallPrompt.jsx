            ...
            {mode === 'android' && (
                <div className="p-4 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="font-semibold text-white text-sm">Installa OwnVault</p>
                        <p className="text-xs text-gray-400 mt-0.5">Accesso rapido dalla schermata Home</p>
                    </div>
                    <button
            ...
            {mode === 'ios' && (
                <div className="p-4">
                    ...
                    <div className="mt-3 flex justify-center">
                        <span className="text-gray-500 text-xs">↓ barra in basso su Safari</span>
                    </div>
                </div>
            )}
        </div>
